...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notes_comment', (
        ...
        db.send_create_signal(u'notes', ['Comment'])

        # Deleting field 'UserProfile.nickname'
        db.delete_column(u'notes_userprofile', 'nickname')


    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table(u'notes_comment')

        # Adding field 'UserProfile.nickname'
        db.add_column(u'notes_userprofile', 'nickname',
    ...
    models = {
        ...
        u'notes.mokoobject': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 25, 0, 0)', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modify_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 25, 0, 0)', 'auto_now': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'notes.note': {
        ...
        u'notes.sendemails': {
            ...
            'schedule': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 25, 0, 0)'}),
