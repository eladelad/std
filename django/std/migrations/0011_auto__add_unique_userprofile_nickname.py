...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserProfile', fields ['nickname']
        db.create_unique(u'notes_userprofile', ['nickname'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserProfile', fields ['nickname']
        db.delete_unique(u'notes_userprofile', ['nickname'])
