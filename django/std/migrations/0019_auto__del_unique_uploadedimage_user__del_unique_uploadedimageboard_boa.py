...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UploadedImageBoard', fields ['board']
        db.delete_unique(u'notes_uploadedimageboard', ['board_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'UploadedImageBoard', fields ['board']
        db.create_unique(u'notes_uploadedimageboard', ['board_id'])
