...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.historyBoards'
        db.add_column(u'notes_userprofile', 'historyBoards',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.historyBoards'
        db.delete_column(u'notes_userprofile', 'historyBoards')
