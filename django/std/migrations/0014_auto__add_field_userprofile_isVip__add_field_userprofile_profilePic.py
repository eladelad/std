...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.isVip'
        db.add_column(u'notes_userprofile', 'isVip',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.profilePic'
        db.add_column(u'notes_userprofile', 'profilePic',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['notes.UploadedImage'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.isVip'
        db.delete_column(u'notes_userprofile', 'isVip')
    ...
    models = {
        ...
        u'notes.mokoobject': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modify_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)', 'auto_now': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'notes.note': {
        ...
        u'notes.sendemails': {
            ...
            'schedule': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)'}),
        ...
        u'notes.userprofile': {
            ...
            'profilePic': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['notes.UploadedImage']", 'null': 'True'}),
