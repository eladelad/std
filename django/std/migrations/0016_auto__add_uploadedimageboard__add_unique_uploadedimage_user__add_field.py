...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UploadedImageBoard'
        db.create_table(u'notes_uploadedimageboard', (
            ...
            ('board', self.gf('django.db.models.fields.related.ForeignKey')(related_name='board_pic', unique=True, null=True, to=orm['notes.Board'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notes.UserProfile'], null=True)),
            ('file', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'notes', ['UploadedImageBoard'])

        # Adding unique constraint on 'UploadedImage', fields ['user']
        db.create_unique(u'notes_uploadedimage', ['user_id'])

        # Adding field 'UploadedFile.note'
        db.add_column(u'notes_uploadedfile', 'note',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='note_file', null=True, to=orm['notes.Note']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'UploadedImage', fields ['user']
        db.delete_unique(u'notes_uploadedimage', ['user_id'])

        # Deleting model 'UploadedImageBoard'
        db.delete_table(u'notes_uploadedimageboard')

        # Deleting field 'UploadedFile.note'
        db.delete_column(u'notes_uploadedfile', 'note_id')
    ...
    models = {
        ...
        u'notes.mokoobject': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 1, 0, 0)', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modify_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 1, 0, 0)', 'auto_now': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'notes.note': {
        ...
        u'notes.sendemails': {
            ...
            'schedule': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 1, 0, 0)'}),
        ...
        u'notes.uploadedfile': {
            ...
            u'mokoobject_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['notes.MokoObject']", 'unique': 'True', 'primary_key': 'True'}),
            'note': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'note_file'", 'null': 'True', 'to': u"orm['notes.Note']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['notes.UserProfile']", 'null': 'True'})
        },
        u'notes.uploadedimage': {
            ...
            u'mokoobject_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['notes.MokoObject']", 'unique': 'True', 'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'profile_pic'", 'unique': 'True', 'null': 'True', 'to': u"orm['notes.UserProfile']"})
        },
        u'notes.uploadedimageboard': {
            'Meta': {'object_name': 'UploadedImageBoard', '_ormbases': [u'notes.MokoObject']},
            'board': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'board_pic'", 'unique': 'True', 'null': 'True', 'to': u"orm['notes.Board']"}),
            'file': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            u'mokoobject_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['notes.MokoObject']", 'unique': 'True', 'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['notes.UserProfile']", 'null': 'True'})
        },
        u'notes.userprofile': {
            ...
            'profilePic': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['notes.UploadedImage']", 'null': 'True', 'blank': 'True'}),
