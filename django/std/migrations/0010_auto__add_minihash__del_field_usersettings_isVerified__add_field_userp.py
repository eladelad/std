...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'miniHash'
        db.create_table(u'notes_minihash', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('minihash', self.gf('django.db.models.fields.CharField')(default='', max_length=8)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal(u'notes', ['miniHash'])

        # Deleting field 'UserSettings.isVerified'
        db.delete_column(u'notes_usersettings', 'isVerified')

        # Adding field 'UserProfile.isVerified'
        db.add_column(u'notes_userprofile', 'isVerified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'miniHash'
        db.delete_table(u'notes_minihash')

        # Adding field 'UserSettings.isVerified'
        db.add_column(u'notes_usersettings', 'isVerified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UserProfile.isVerified'
        db.delete_column(u'notes_userprofile', 'isVerified')
    ...
    models = {
        ...
        u'notes.mokoobject': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 19, 0, 0)', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modify_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 19, 0, 0)', 'auto_now': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'notes.note': {
        ...
        u'notes.sendemails': {
            ...
            'schedule': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 19, 0, 0)'}),
