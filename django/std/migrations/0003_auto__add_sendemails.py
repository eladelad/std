...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'sendEmails'
        db.create_table(u'notes_sendemails', (
            ...
            ('tokens', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('schedule', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 17, 0, 0))),
            ('recipient', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal(u'notes', ['sendEmails'])


    def backwards(self, orm):
        # Deleting model 'sendEmails'
        db.delete_table(u'notes_sendemails')
    ...
    models = {
        ...
        u'notes.mokoobject': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modify_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)', 'auto_now': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'notes.note': {
        ...
        u'notes.sendemails': {
            ...
            'schedule': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
