...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'sendEmails.message'
        db.add_column(u'notes_sendemails', 'message',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=100),
                      keep_default=False)


        # Changing field 'sendEmails.note'
        db.alter_column(u'notes_sendemails', 'note_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notes.Note'], null=True))
        # Adding field 'Board.isArchived'
        db.add_column(u'notes_board', 'isArchived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'sendEmails.message'
        db.delete_column(u'notes_sendemails', 'message')


        # Changing field 'sendEmails.note'
        db.alter_column(u'notes_sendemails', 'note_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['notes.Note']))
        # Deleting field 'Board.isArchived'
        db.delete_column(u'notes_board', 'isArchived')
