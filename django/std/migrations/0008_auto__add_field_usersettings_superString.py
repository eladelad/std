...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSettings.superString'
        db.add_column(u'notes_usersettings', 'superString',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSettings.superString'
        db.delete_column(u'notes_usersettings', 'superString')
