...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'sendEmails.title'
        db.add_column(u'notes_sendemails', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Email From KlipBord', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'sendEmails.title'
        db.delete_column(u'notes_sendemails', 'title')
