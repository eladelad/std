...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.favBoards'
        db.add_column(u'notes_userprofile', 'favBoards',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.favBoards'
        db.delete_column(u'notes_userprofile', 'favBoards')
