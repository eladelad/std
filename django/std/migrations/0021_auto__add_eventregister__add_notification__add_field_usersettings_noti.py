...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notes_eventregister', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notes.UserProfile'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'notes', ['eventRegister'])

        # Adding model 'notification'
        db.create_table(u'notes_notification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 8, 7, 0, 0), auto_now_add=True, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notes.UserProfile'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notes.historyLog'])),
        ...
        db.send_create_signal(u'notes', ['notification'])

        # Adding field 'UserSettings.notifyByMail'
        db.add_column(u'notes_usersettings', 'notifyByMail',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'notes_eventregister')

        # Deleting model 'notification'
        db.delete_table(u'notes_notification')

        # Deleting field 'UserSettings.notifyByMail'
        db.delete_column(u'notes_usersettings', 'notifyByMail')
    ...
    models = {
        ...
        u'notes.historylog': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 7, 0, 0)', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'notes.mokoobject': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 7, 0, 0)', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modify_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 7, 0, 0)', 'auto_now': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'notes.note': {
        ...
        u'notes.sendemails': {
            ...
            'schedule': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 7, 0, 0)'}),
